         ...
         <div class="navbar-header">
             ...
             <a class="navbar-brand" href="{{ route('dashboard') }}">
                 ...
                 <span class="logo-text">
                     <!-- dark Logo text -->
                     <img src="{{ asset('public/assets/images/kalpak-logo.jpeg') }}" alt="homepage" class="dark-logo w-75" />
                 </span>
             </a>
             <!-- -------------------------------------------------------------- -->
             <!-- End Logo -->
                         ...
                         <ul class="list-style-none">
                             ...
                             <li>
                                 <div class="message-center message-body">
                                     ...
                                     <a href="#" class="message-item">
                                         <span class="user-img">
                                             <img src="{{ asset('public/assets/images/1.jpg') }}" alt="user"
                                     ...
                                     <a href="#" class="message-item">
                                         <span class="user-img">
                                             <img src="{{ asset('public/assets/images/2.jpg') }}" alt="user"
                                                 class="rounded-circle" />
                                     ...
                                     <a href="#" class="message-item">
                                         <span class="user-img">
                                             <img src="{{ asset('public/assets/images/3.jpg') }}" alt="user"
                                                 class="rounded-circle" />
                                     ...
                                     <a href="#" class="message-item">
                                         <span class="user-img">
                                             <img src="{{ asset('public/assets/images/4.jpg') }}" alt="user"
                                                 class="rounded-circle" />
                 ...
                 <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                         data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                             src="{{ asset('public/assets/images/2.jpg') }}" alt="user" class="rounded-circle"
                             width="31" /></a>
                     <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                         <span class="with-arrow"><span class="bg-primary"></span></span>
                         <div class="d-flex no-block align-items-center p-3 bg-primary text-white mb-2">
                             <div class="">
                                 <img src="{{ asset('public/assets/images/2.jpg') }}" alt="user" class="rounded-circle"
                                     width="60" />
                             </div>
                             <div class="ms-2">
